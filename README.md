...
See below or https://github.com/guyroyse/vending-machine-kata for more info.

Some adjustments have been made to localize this kata
...
The vending machine will accept valid coins (~~nickels, dimes, and quarters~~ five-, ten-, twenty-, fifty eurocents or one or two euro's) and reject invalid ones (pennies).  When a
